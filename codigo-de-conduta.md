...
Código de Conduta Geral da Comunidade: [https://github.com/phpwomenbr/docs/blob/master/codigo-de-conduta-comunidade.md]
Código de Conduta para Eventos: [https://github.com/phpwomenbr/docs/blob/master/codigo-de-conduta-eventos.md]
